...
namespace library
{
    ...
    partial void OnEnterPasswordChanging(string value);
    partial void OnEnterPasswordChanged();
    ...
    partial void OnClassificationChanged();
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_EnterPassword", DbType="VarChar(30)")]
		public string EnterPassword
		{
			...
			set
			{
				if ((this._EnterPassword != value))
				{
					this.OnEnterPasswordChanging(value);
					this.SendPropertyChanging();
					this._EnterPassword = value;
					this.SendPropertyChanged("EnterPassword");
					this.OnEnterPasswordChanged();
				}
			}
		}
