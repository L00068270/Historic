...
namespace MyClassesLibrary
{
    class LibraryMemberCompare : IComparer
    {
        ...
        public int Compare(object x, object y)
        {
            ...
            LibraryMember L2 = y as LibraryMember;
            ...
            return L1.Password.CompareTo(L2.Password);
            return L1.ConfirmPassword.CompareTo(L2.ConfirmPassword);
            return L1.Address.CompareTo(L2.Address);
            return L1.Street.CompareTo(L2.Street);
            return L1.Town.CompareTo(L2.Town);
            return L1.County.CompareTo(L2.County);
